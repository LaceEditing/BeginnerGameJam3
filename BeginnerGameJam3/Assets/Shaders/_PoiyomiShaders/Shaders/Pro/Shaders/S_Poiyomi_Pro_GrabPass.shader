Shader ".poiyomi/★ Pro Grabpass ★"
{
    Properties
    {
        ...
        [HideInInspector] shader_master_label ("<color=#000000ff>Poiyomi Pro V7.3.013</color>", Float) = 0
        ...
        [HideInInspector][Enum(UV0, 0, UV1, 1, UV2, 2, UV3, 3, DistortedUV1, 4)]_RGBAlpha_UV ("UV", int) = 0
        ...
        [HideInInspector][Enum(UV0, 0, UV1, 1, UV2, 2, UV3, 3, DistortedUV1, 4)]_RgbNormalAUV ("UV", int) = 0
        ...
        */
        ...
        // Poiyomi Pathing
        [HideInInspector] m_start_pathing ("Pathing--{reference_property: _EnablePathing, is_hideable:true}", Float) = 0
        ...
        [HideInInspector][Enum(UV0, 0, UV1, 1, UV2, 2, UV3, 3, DistortedUV1, 4)] _PathingMapUV ("UV", Int) = 0
        ...
        [HideInInspector][Enum(UV0, 0, UV1, 1, UV2, 2, UV3, 3, DistortedUV1, 4)] _PathingColorMapUV ("UV", Int) = 0
        ...
        [HideInInspector] m_start_PathAudioLink ("Audio Link ♫--{is_hideable:true, condition_showS:_EnableAudioLink==1}", Float) = 0
        // Time Offsets
        [Header(Time Offset)]
        ...
        // Start Patreon
        [HideInInspector] m_Patreon ("Patreon--{is_hideable:true}", Float) = 0
        
        // Video Options
        [HideInInspector] m_start_Video ("Video--{reference_property:_EnableVideo,is_hideable:true}", Float) = 0
        ...
        [HideInInspector] m_start_Bulge ("Bulge--{reference_property:_EnableBulge,is_hideable:true}", Float) = 0
        ...
        // Hologram
        [HideInInspector] m_start_Hologram ("Hologram Alpha--{reference_property:_EnableHolo, is_hideable:true}", Float) = 0
        ...
        // GrabPass
        [HideInInspector] m_start_GrabPass ("GrabPass Transparency--{reference_property:_commentIfZero_EnableGrabpass, is_hideable:true}", Float) = 0
        ...
        [HideInInspector] m_start_Refraction ("Refraction--{reference_property:_RefractionEnabled, is_hideable:true}", Float) = 0
        ...
        [HideInInspector] m_start_Blur ("Blur--{reference_property:_EnableBlur, is_hideable:true}", Float) = 0
        ...
        // Iridescence
        [HideInInspector] m_start_Iridescence ("Iridescence--{reference_property:_EnableIridescence, is_hideable:true}", Float) = 0
        ...
        [HideInInspector] m_start_IridescenceAudioLink ("Audio Link ♫--{is_hideable:true, condition_showS:_EnableAudioLink==1}", Float) = 0
        ...
        // Vertex Glitching
        [HideInInspector] m_start_VertexGlitch ("Vertex Glitching--{reference_property:_EnableVertexGlitch, is_hideable:true}", Float) = 0
        ...
        [HideInInspector] m_start_ScifiSpawnIn ("Sci Fi--{reference_property:_EnableScifiSpawnIn, is_hideable:true}", Float) = 0
        ...
        // Voronoi
        [HideInInspector] m_start_Voronoi ("Voronoi--{reference_property:_EnableVoronoi, is_hideable:true}", Float) = 0
        ...
        [HideInInspector] m_start_BlackLight ("Black Light Mask--{reference_property:_BlackLightMaskEnabled, is_hideable:true}", Float) = 0
        ...
        // Raliv
        [HideInInspector] m_start_raliv ("Raliv Dynamic Penetration System--{button_right:{text:Gumroad,action:{type:URL,data:https://gumroad.com/l/lwthuB},hover:Buy},is_hideable:true}", Float) = 0
        // Penetrator
